# Agent Cloud 移动端接入 Plan B
**状态：** 详细设计
**日期：** 2026-07-10
**本轮范围：** Plan B V1 自有移动入口实现、测试与提交前 blocker 修复。
## 1. 结论
采用 Plan B：复用 Agent Cloud 的 Pod、Relay、Runner、Wasm Core 与现有 Web
...
- `codexapp` 是独立工作台，不认识 Agent Cloud 的 Org、Pod、Runner 与 RBAC。

Agent Cloud 已具备上述底座能力。直接引入 lulu 会形成双运行时、双 Relay、
...
- [终端移动布局](/Users/wwyz/Documents/code/Agent Cloud/clients/web/src/components/workspace/WorkspaceManager.tsx:68)
- [终端 Pane](/Users/wwyz/Documents/code/Agent Cloud/clients/web/src/components/workspace/TerminalPane.tsx:1)
- [ACP 组合](/Users/wwyz/Documents/code/Agent Cloud/clients/web/src/components/workspace/AgentPanel.tsx:54)
- [Pod 读取写入 Rust Core](/Users/wwyz/Documents/code/Agent Cloud/clients/web/src/stores/pod.ts:96)
- [预览入口](/Users/wwyz/Documents/code/Agent Cloud/backend/internal/api/rest/v1/pod_preview.go:39)
- [预览路由解析](/Users/wwyz/Documents/code/Agent Cloud/backend/internal/service/relay/preview.go:28)
...
来源：[WASM transport](/Users/wwyz/Documents/code/Agent Cloud/clients/core/crates/transport/src/wasm.rs:29)。
...
发出 `Resync` 并重放最后有效尺寸。[重连](/Users/wwyz/Documents/code/Agent Cloud/clients/core/crates/relay/src/driver/mod.rs:143)
与 [resync/resize](/Users/wwyz/Documents/code/Agent Cloud/clients/core/crates/relay/src/driver/session.rs:56)
