...
> 2026-07-15 更新：本文关于“LoopScript 选择 Worker”的结论已被运行环境
> 解耦设计替代。LoopScript 只描述执行过程，Worker 快照在启动请求中选择；
> 详见 `2026-07-15-loop-runtime-separation-design.md`。
...
V1 实现采用 Blockly 12.5、CodeMirror 6、Go LoopScript 编译器、ConnectRPC
