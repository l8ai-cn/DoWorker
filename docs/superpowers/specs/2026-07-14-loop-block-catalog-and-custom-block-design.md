...
- 日期：2026-07-14
- 状态：历史方案，Worker 积木部分已废弃
- 依赖：`2026-07-14-loop-language-and-ast-design.md`

> 2026-07-15 更新：运行环境不再作为可编排积木。当前工具箱不包含
> Worker，智能体任务也不引用 Worker；启动循环时由独立弹窗选择运行环境。
> 当前权威设计见 `2026-07-15-loop-runtime-separation-design.md`。
