...
func toMCPWorkflowSummary(l *workflowDomain.Workflow) *mcpWorkflowSummary {
	s := &mcpWorkflowSummary{
		Slug:           l.Slug,
		Name:           l.Name,
		Status:         l.Status,
...
func toMCPRunSummary(r *workflowDomain.WorkflowRun) *mcpRunSummary {
	s := &mcpRunSummary{
		ID:          r.ID,
