...
type Pod struct {
	...
	PodResourceBindings `gorm:"embedded"`
	...
	// Virtual field: populated by service layer from the workflow run relation.
	Workflow *PodWorkflowInfo `gorm:"-" json:"workflow,omitempty"`
}

type PodWorkflowInfo struct {
	ID   int64  `json:"id"`
