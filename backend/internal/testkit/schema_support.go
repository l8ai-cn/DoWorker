...
func supportTableDDLs() []string {
	return []string{
		...
		`CREATE TABLE IF NOT EXISTS installed_skills (
			id INTEGER PRIMARY KEY AUTOINCREMENT,
			organization_id INTEGER NOT NULL, repository_id INTEGER NOT NULL,
			skill_id INTEGER, scope TEXT NOT NULL DEFAULT 'org',
		...
		`CREATE TABLE IF NOT EXISTS skills (
			id INTEGER PRIMARY KEY AUTOINCREMENT,
			organization_id INTEGER, slug TEXT NOT NULL,
			...
			upstream_subdir TEXT NOT NULL DEFAULT '',
			upstream_commit_sha TEXT NOT NULL DEFAULT '',
			install_source TEXT NOT NULL DEFAULT 'gitops',
