...
6. Call `workbench.publish_artifact` with a video manifest whose playable representation is `artifacts/seedance-video.mp4` and media type is `video/mp4`.
7. Report the task ID, output path, and generation status.
