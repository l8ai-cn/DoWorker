// Agent Cloud installability / update-only service worker (hand-rolled).
//
// Agent Cloud is a cloud app with NO offline mode, so this worker deliberately:
...
const CACHE_NAME = `agent-cloud-pwa-${BUILD_VERSION}`;
