...
const CODEX_NATIVE_COLLABORATION_MODE_LABEL_KEY = "agent-cloud.codex_native.collaboration_mode";
...
export function isCodexNativeSession(source: CodexPlanModeLabelSource): boolean {
  return source?.labels?.["agent-cloud.wrapper"] === CODEX_NATIVE_WRAPPER;
}
