export const WRAPPER_LABEL_KEY = "agent-cloud.wrapper";
export const UI_MODE_LABEL_KEY = "agent-cloud.ui";
export const UI_MODE_TERMINAL_VALUE = "terminal";
export const CLOSED_LABEL_KEY = "agent-cloud.closed";
export const FORK_SOURCE_LABEL_KEY = "agent-cloud.fork.source_id";

const LEGACY_LABEL_ALIASES: Record<string, string> = {
  "agent-cloud.ui": UI_MODE_LABEL_KEY,
  "omnigent.wrapper": WRAPPER_LABEL_KEY,
  "agent-cloud.closed": CLOSED_LABEL_KEY,
