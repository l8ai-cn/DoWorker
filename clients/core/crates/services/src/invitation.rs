...
use agentcloud_types::proto_invitation_v1 as inv_proto;
use prost::Message;
...
impl InvitationService {
    ...
    pub async fn list_pending_invitations_connect(
        ...
        let resp = self
            .client
            .list_pending_invitations_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_invitation_by_token_connect(
        ...
        let resp = self
            .client
            .get_invitation_by_token_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
