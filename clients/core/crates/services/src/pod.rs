...
impl PodService {
    ...
    pub async fn update_pod_perpetual_connect(
        ...
        let resp = self
            .client
            .update_pod_perpetual_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_pod_connection_connect(
        ...
        let resp = self
            .client
            .get_pod_connection_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn list_pods_by_ticket_connect(
        ...
        let resp = self
            .client
            .list_pods_by_ticket_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
