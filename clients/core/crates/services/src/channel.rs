...
impl ChannelService {
    connect_bridge!(
        list_channels_connect,
        ListChannelsRequest,
        list_channels_connect
    );
    connect_bridge!(get_channel_connect, GetChannelRequest, get_channel_connect);
    connect_bridge!(
        create_channel_connect,
        CreateChannelRequest,
        create_channel_connect
    );
    connect_bridge!(
        update_channel_connect,
        UpdateChannelRequest,
        update_channel_connect
    );
    connect_bridge!(
        archive_channel_connect,
        ArchiveChannelRequest,
        archive_channel_connect
    );
    connect_bridge!(
        unarchive_channel_connect,
        UnarchiveChannelRequest,
        unarchive_channel_connect
    );
    connect_bridge!(
        get_channel_document_connect,
        GetChannelDocumentRequest,
        get_channel_document_connect
    );
    connect_bridge!(
        update_channel_document_connect,
        UpdateChannelDocumentRequest,
        update_channel_document_connect
    );
    connect_bridge!(
        list_channel_messages_connect,
        ListChannelMessagesRequest,
        list_channel_messages_connect
    );
    connect_bridge!(
        search_channel_messages_connect,
        SearchChannelMessagesRequest,
        search_channel_messages_connect
    );
    connect_bridge!(
        send_channel_message_connect,
        SendChannelMessageRequest,
        send_channel_message_connect
    );
    connect_bridge!(
        edit_channel_message_connect,
        EditChannelMessageRequest,
        edit_channel_message_connect
    );
    connect_bridge!(
        delete_channel_message_connect,
        DeleteChannelMessageRequest,
        delete_channel_message_connect
    );
    connect_bridge!(
        mark_channel_read_connect,
        MarkChannelReadRequest,
        mark_channel_read_connect
    );
    connect_bridge!(
        get_channel_unread_counts_connect,
        GetChannelUnreadCountsRequest,
        get_channel_unread_counts_connect
    );
    connect_bridge!(
        mute_channel_connect,
        MuteChannelRequest,
        mute_channel_connect
    );
    connect_bridge!(
        list_channel_members_connect,
        ListChannelMembersRequest,
        list_channel_members_connect
    );
    connect_bridge!(
        join_channel_connect,
        JoinChannelRequest,
        join_channel_connect
    );
    connect_bridge!(
        leave_channel_connect,
        LeaveChannelRequest,
        leave_channel_connect
    );
    connect_bridge!(
        invite_channel_members_connect,
        InviteChannelMembersRequest,
        invite_channel_members_connect
    );
    connect_bridge!(
        remove_channel_member_connect,
        RemoveChannelMemberRequest,
        remove_channel_member_connect
    );
    connect_bridge!(
        list_channel_pods_connect,
        ListChannelPodsRequest,
        list_channel_pods_connect
    );
    connect_bridge!(
        join_channel_pod_connect,
        JoinChannelPodRequest,
        join_channel_pod_connect
    );
    connect_bridge!(
        leave_channel_pod_connect,
        LeaveChannelPodRequest,
        leave_channel_pod_connect
    );
}
