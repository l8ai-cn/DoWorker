...
impl WorkflowService {
    ...
    pub async fn list_workflow_runs_connect(
        ...
        let resp = self
            .client
            .list_workflow_runs_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn cancel_workflow_run_connect(
        ...
        let resp = self
            .client
            .cancel_workflow_run_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
