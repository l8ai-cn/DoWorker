...
use agentcloud_types::proto_billing_v1 as billing_proto;
use prost::Message;
...
impl BillingService {
    ...
    pub async fn get_overview_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .get_billing_overview_connect(&req)
            .await
            .map_err(crate::wire)?;
    ...
    pub async fn list_plans_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .list_billing_plans_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_subscription_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .get_billing_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn create_subscription_connect(
        ...
        let resp = self
            .client
            .create_billing_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn update_subscription_connect(
        ...
        let resp = self
            .client
            .update_billing_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn cancel_subscription_connect(
        ...
        let resp = self
            .client
            .cancel_billing_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn request_cancel_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .request_cancel_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn reactivate_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .reactivate_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn upgrade_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .upgrade_subscription_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn change_cycle_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .change_billing_cycle_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn list_invoices_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .list_billing_invoices_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn create_checkout_connect(&self, request_bytes: &[u8]) -> Result<Vec<u8>, String> {
        ...
        let resp = self
            .client
            .create_billing_checkout_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_checkout_status_connect(
        ...
        let resp = self
            .client
            .get_billing_checkout_status_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_deployment_info_connect(
        ...
        let resp = self
            .client
            .get_billing_deployment_info_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_public_pricing_connect(
        ...
        let resp = self
            .client
            .get_public_pricing_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_public_deployment_info_connect(
        ...
        let resp = self
            .client
            .get_public_deployment_info_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
