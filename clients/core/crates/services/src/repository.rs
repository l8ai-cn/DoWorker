...
use agentcloud_types::proto_repository_v1 as repo_proto;
use prost::Message;
...
impl RepositoryService {
    ...
    pub async fn list_repository_branches_connect(
        ...
        let resp = self
            .client
            .list_repository_branches_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn sync_repository_branches_connect(
        ...
        let resp = self
            .client
            .sync_repository_branches_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn list_repository_merge_requests_connect(
        ...
        let resp = self
            .client
            .list_repository_merge_requests_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn register_repository_webhook_connect(
        ...
        let resp = self
            .client
            .register_repository_webhook_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn delete_repository_webhook_connect(
        ...
        let resp = self
            .client
            .delete_repository_webhook_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_repository_webhook_status_connect(
        ...
        let resp = self
            .client
            .get_repository_webhook_status_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_repository_webhook_secret_connect(
        ...
        let resp = self
            .client
            .get_repository_webhook_secret_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn mark_repository_webhook_configured_connect(
        ...
        let resp = self
            .client
            .mark_repository_webhook_configured_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
