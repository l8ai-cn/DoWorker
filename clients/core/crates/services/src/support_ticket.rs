...
impl SupportTicketService {
    ...
    pub async fn list_support_tickets_connect(
        ...
        let resp = self
            .client
            .list_support_tickets_connect(&req)
            .await
            .map_err(crate::wire)?;
    ...
    pub async fn get_support_ticket_connect(
        ...
        let resp = self
            .client
            .get_support_ticket_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_attachment_url_connect(
        ...
        let resp = self
            .client
            .get_support_ticket_attachment_url_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn create_support_ticket_connect(
        ...
        let resp = self
            .client
            .create_support_ticket_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn add_support_ticket_message_connect(
        ...
        let resp = self
            .client
            .add_support_ticket_message_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn presign_attachment_upload_connect(
        ...
        let resp = self
            .client
            .presign_support_ticket_attachment_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn associate_attachments_connect(
        ...
        let resp = self
            .client
            .associate_support_ticket_attachments_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
