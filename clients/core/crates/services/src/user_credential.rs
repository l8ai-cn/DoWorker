// proto.user_credential.v1 — UserGitCredentialService and
// UserRepositoryProviderService share this
...
impl UserCredentialService {
    ...
    pub async fn get_git_credential_connect(
        ...
        let resp = self
            .client()
            .get_git_credential_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn create_git_credential_connect(
        ...
        let resp = self
            .client()
            .create_git_credential_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn update_git_credential_connect(
        ...
        let resp = self
            .client()
            .update_git_credential_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn delete_git_credential_connect(
        ...
        let resp = self
            .client()
            .delete_git_credential_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_default_git_credential_connect(
        ...
        let resp = self
            .client()
            .get_default_git_credential_connect()
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn set_default_git_credential_connect(
        ...
        let resp = self
            .client()
            .set_default_git_credential_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn clear_default_git_credential_connect(
        ...
        let resp = self
            .client()
            .clear_default_git_credential_connect()
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
...
impl UserCredentialService {
    pub async fn list_repository_providers_connect(
        ...
        let resp = self
            .client()
            .list_repository_providers_connect()
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn get_repository_provider_connect(
        ...
        let resp = self
            .client()
            .get_repository_provider_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn create_repository_provider_connect(
        ...
        let resp = self
            .client()
            .create_repository_provider_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn update_repository_provider_connect(
        ...
        let resp = self
            .client()
            .update_repository_provider_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn delete_repository_provider_connect(
        ...
        let resp = self
            .client()
            .delete_repository_provider_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn set_default_repository_provider_connect(
        ...
        let resp = self
            .client()
            .set_default_repository_provider_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn test_repository_provider_connection_connect(
        ...
        let resp = self
            .client()
            .test_repository_provider_connection_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
    ...
    pub async fn list_provider_repositories_connect(
        ...
        let resp = self
            .client()
            .list_provider_repositories_connect(&req)
            .await
            .map_err(crate::wire)?;
        Ok(resp.encode_to_vec())
    }
