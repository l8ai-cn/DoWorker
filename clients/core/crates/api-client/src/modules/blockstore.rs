...
impl ApiClient {
    ...
    pub async fn blockstore_list_workspaces_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/ListWorkspaces",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_ensure_default_workspace_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/EnsureDefaultWorkspace",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_create_workspace_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/CreateWorkspace",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_delete_workspace_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/DeleteWorkspace",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_list_children_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/ListChildren",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_list_backlinks_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/ListBacklinks",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_get_subtree_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/GetSubtree",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_stream_ops_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/StreamOps",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_export_workspace_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/ExportWorkspace",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_list_type_defs_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/ListTypeDefs",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_get_block_at_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/GetBlockAt",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_semantic_search_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/SemanticSearch",
            req,
        )
        .await
    }
    ...
    pub async fn blockstore_memory_retrieve_connect(
        ...
        connect_call(
            self,
            "/proto.blockstore.v1.BlockstoreService/MemoryRetrieve",
            req,
        )
        .await
    }
