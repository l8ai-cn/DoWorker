...
impl ApiClient {
    pub async fn list_workflows_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/ListWorkflows",
            req,
        )
        .await
    }

    pub async fn get_workflow_connect(
        &self,
        req: &lp::GetWorkflowRequest,
    ...
    pub async fn create_workflow_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/CreateWorkflow",
            req,
        )
        .await
    }
    ...
    pub async fn update_workflow_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/UpdateWorkflow",
            req,
        )
        .await
    }
    ...
    pub async fn delete_workflow_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/DeleteWorkflow",
            req,
        )
        .await
    }
    ...
    pub async fn enable_workflow_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/EnableWorkflow",
            req,
        )
        .await
    }
    ...
    pub async fn disable_workflow_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/DisableWorkflow",
            req,
        )
        .await
    }
    ...
    pub async fn trigger_workflow_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/TriggerWorkflow",
            req,
        )
        .await
    }
    ...
    pub async fn list_workflow_runs_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/ListWorkflowRuns",
            req,
        )
        .await
    }
    ...
    pub async fn cancel_workflow_run_connect(
        ...
        connect_call(
            self,
            "/proto.workflow.v1.WorkflowService/CancelWorkflowRun",
            req,
        )
        .await
    }
