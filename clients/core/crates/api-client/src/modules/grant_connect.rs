...
use crate::ApiClient;
use agentcloud_types::proto_grant_v1 as gp;
...
impl ApiClient {
    pub async fn list_grants_connect(
        ...
        connect_call(self, "/proto.grant.v1.GrantService/ListGrants", req).await
    }
    ...
    pub async fn create_grant_connect(
        ...
        connect_call(self, "/proto.grant.v1.GrantService/CreateGrant", req).await
    }
    ...
    pub async fn delete_grant_connect(
        ...
        connect_call(self, "/proto.grant.v1.GrantService/DeleteGrant", req).await
    }
}
