interface AgentsMeshMarkProps {
  className?: string;
}

export function AgentsMeshMark({ className }: AgentsMeshMarkProps) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="admin-am-logo-bg" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#0F766E" />
          <stop offset="100%" stopColor="#0B5F59" />
        </linearGradient>
      </defs>
      <rect width="400" height="400" rx="32" fill="url(#admin-am-logo-bg)" />
