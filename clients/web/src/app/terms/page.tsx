        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Agent Cloud is a multi-agent AI code collaboration platform that provides:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>AgentPod: Remote AI workstations for running AI coding agents</li>
              <li>Agent Cloud Channels: Communication infrastructure for multi-agent collaboration</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Any paid service, usage commitment, or support package is governed by the applicable order form or written agreement between you and Agent Cloud.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Service operates on a BYOK model where you provide your own AI provider API keys. You are responsible for all charges incurred with your AI providers (Anthropic, OpenAI, Google, etc.). Agent Cloud does not control or limit your usage of external AI services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Agent Cloud encrypts stored credentials but is not liable for any unauthorized access resulting from your failure to protect your credentials or from security breaches beyond our reasonable control.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Service, including its software, design, features, and documentation, is owned by Agent Cloud and protected by intellectual property laws. You may not copy, modify, distribute, sell, or lease any part of our Service without written permission.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              ...
              <li>Agent Cloud is not responsible for data processed on your infrastructure</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The Service integrates with third-party services including AI providers (Anthropic, OpenAI, Google) and Git providers (GitHub, GitLab, Gitee). Your use of these services is subject to their respective terms of service. Agent Cloud is not responsible for the availability, accuracy, or content of third-party services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, AGENTCLOUD SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM:
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Agent Cloud regarding the Service and supersede all prior agreements and understandings.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 surface-card p-4 text-muted-foreground">
              ...
              <p>Email:{" "}
                <a href="mailto:legal@agentcloud.ai" className="text-primary hover:underline">
                  legal@agentcloud.ai
                </a>
              </p>
            </div>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Agent Cloud shall not be liable for any failure or delay in performing its obligations under these Terms due to circumstances beyond its reasonable control, including but not limited to acts of God, natural disasters, war, terrorism, riots, embargoes, acts of civil or military authorities, fire, floods, accidents, pandemics, strikes, or shortages of transportation, facilities, fuel, energy, labor, or materials.
            </p>
          </section>
        </div>
      </main>
