...
const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/l8ai-cn/AgentCloud",
    icon: (
  ...
  const footerLinks = {
    ...
    resources: {
      ...
      links: [
        ...
        { label: t("landing.footer.resources.github"), href: "https://github.com/l8ai-cn/AgentCloud" },
    ...
    company: {
      ...
      links: [
        ...
        { label: t("landing.footer.company.contact"), href: "mailto:support@agentcloud.ai" },
      ],
    },
    legal: {
