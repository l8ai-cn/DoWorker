...
export function PendingOpsBadge() {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="pointer-events-auto fixed bottom-6 left-6 z-50 flex items-center gap-2 rounded-full border border-warning bg-warning-bg px-3 py-1.5 text-xs text-warning shadow hover:bg-warning-bg/80"
