---
title: 'Construir Agent Cloud con Agent Cloud: 52 dias de Harness Engineering en solitario'
...
Yo comence a construir **Agent Cloud** hace poco mas de 50 dias. 52 dias, 600 commits, 965,687 lineas de codigo procesadas, 356,220 lineas de codigo actualmente en produccion. Una sola persona.
...
Esta es la intencion de diseno central de Agent Cloud. Y fue construyendolo con el mismo sistema que realmente lo comprendi.

## El colapso del coste de ensayo y error: hora de actualizar la metodologia

La arquitectura Relay de Agent Cloud no se diseno en una pizarra. La forjo el entorno de produccion.
...
La tesis central de Agent Cloud: los agentes de IA pueden, bajo un Harness estructurado, colaborar para completar tareas de ingenieria complejas.

Yo use Agent Cloud para construir Agent Cloud.
...
Si en tu propia practica de Harness Engineering has descubierto algo valioso, te invitamos a compartirlo en [GitHub Discussions](https://github.com/l8ai-cn/AgentCloud/discussions) o directamente en un [Issue](https://github.com/l8ai-cn/AgentCloud/issues). Este proyecto se construyo con agentes, y deberia seguir evolucionando impulsado por agentes e ingenieros por igual.
