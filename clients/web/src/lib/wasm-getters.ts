import {
  ...
  WasmRunnerService, WasmWorkflowService, WasmGoalLoopService, WasmAutopilotService,
...
export function registerAll(client: WasmApiClient, authManager: WasmAuthManager) {
  registerServiceProvider({
    ...
    workflowService: client.create_workflow_service(),
    goalLoopService: client.create_goal_loop_service(),
    ...
    agentWorkbenchService: client.create_agent_workbench_service(),
    agentWorkbenchState: client.get_agent_workbench_state(),
    ...
    workflowState: client.get_workflow_state(),
    acpManager: client.get_acp_manager(),
    loopalManager: client.get_loopal_manager(),
    loopBuilderState: client.get_loop_builder_state(),
...
export {
  ...
  getChannelState, getWorkflowState, getAcpManager, getLoopalManager,
  getLoopBuilderState,
