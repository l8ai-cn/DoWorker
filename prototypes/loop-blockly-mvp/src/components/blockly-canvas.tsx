...
import { registerLoopBlocks } from "../blockly/block-catalog";
import { loopTheme } from "../blockly/block-theme";
import { createLoopToolbox } from "../blockly/toolbox";
import {
  registerCustomBlock,
...
export function BlocklyCanvas({
  ...
  useEffect(() => {
    ...
    const workspace = Blockly.inject(container, {
      toolbox: createLoopToolbox(customDefinitions),
      theme: loopTheme,
      renderer: "zelos",
      trashcan: true,
  ...
  useEffect(() => {
    ...
    workspace.updateToolbox(createLoopToolbox(customDefinitions));
  }, [customDefinitions]);
