...
const STORAGE_KEY = "loop-blockly-mvp.project.v1";

export type OutputTab = "diagnostics" | "json" | "evidence";

export interface LoopStoredProject {
  version: 1;
...
export interface LoopProjectLoadResult {
  project?: LoopStoredProject;
  error?: string;
}
...
export function loadLoopProject(): LoopProjectLoadResult {
  try {
...
export function saveLoopProject(
  workspace: Blockly.Workspace,
  customDefinitions: CustomBlockDefinition[],
  outputTab: OutputTab,
): StorageResult {
  try {
    const project: LoopStoredProject = {
      version: 1,
...
export function clearLoopProject(): StorageResult {
  try {
